...
import { HomeNavigation } from "@/components/dashboardBusiness/home-navigation"
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <div className="space-y-8">
          <TodayTask />
          <BudgetPanel startupPlanId={startupPlanId}/>
        </div>
        <div className="space-y-8">
        <RisksPanel startupPlanId={startupPlanId} />
        <MotivationalTip  startupPlanId={startupPlanId}/>
        <HomeNavigation  startupPlanId={startupPlanId} />
