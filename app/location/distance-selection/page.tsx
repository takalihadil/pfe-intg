...
export default function DistanceSelectionPage() {
  ...
  useEffect(() => {
    ...
    // Fetch location ID when component mounts
  ...
  const handleBudgetSubmit = async () => {
    ...
    try {
      ...
      // Update budget using the new endpoint
      const budgetResponse = await fetch(
        `http://localhost:3000/userlocation/${locationId}/updateBudgetRange`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
          ...
          body: JSON.stringify({
            budgetRange: Number(budget)   // ← matches @Body('budgetRange')
          })
        }
      );
      ...
      setTimeout(() => {
        router.push("/location/suggestions");
        router.refresh();
      }, 500);
              ...
              >
                <div className="text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg">
                      Help us find the best matches for your needs
                    </p>
                  </div>
                </div>
